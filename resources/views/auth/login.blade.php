...
@section('content')
                ...
                <div class="grid min-h-screen place-items-center">
                    <div class="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
                        ...
                        <h1 class="text-xl font-semibold">Hola 👋, <span class="font-normal">por favor, rellene con tu información para ingresar a 
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-6">
                        ...
                        <div class="">
                            <label for="email" 
                            class="block  font-normal text-gray-600">{{ __('E-Mail Address') }}</label>
